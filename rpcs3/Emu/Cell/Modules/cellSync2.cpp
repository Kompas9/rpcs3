...
s32 cellSync2MutexInitialize(vm::ptr<CellSync2Mutex> mutex, vm::ptr<void> buffer, vm::cptr<CellSync2MutexAttribute> attr)
{
	cellSync2.todo("cellSync2MutexInitialize(mutex=*0x%x, buffer=*0x%x, attr=*0x%x)", mutex, buffer, attr);

	if (!mutex || !attr || (attr->maxWaiters && !buffer))
		return CELL_SYNC2_ERROR_NULL_POINTER;
...
s32 cellSync2MutexFinalize(vm::ptr<CellSync2Mutex> mutex)
{
...
s32 cellSync2MutexLock(vm::ptr<CellSync2Mutex> mutex, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2MutexTryLock(vm::ptr<CellSync2Mutex> mutex, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2MutexUnlock(vm::ptr<CellSync2Mutex> mutex, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2CondInitialize(vm::ptr<CellSync2Cond> cond, vm::ptr<CellSync2Mutex> mutex, vm::ptr<void> buffer, vm::cptr<CellSync2CondAttribute> attr)
{
...
s32 cellSync2CondFinalize(vm::ptr<CellSync2Cond> cond)
{
...
s32 cellSync2CondWait(vm::ptr<CellSync2Cond> cond, vm::cptr<CellSync2ThreadConfig> config)
{
	cellSync2.todo("cellSync2CondFinalize(cond=*0x%x, config=*0x%x)", cond, config);
...
s32 cellSync2CondSignal(vm::ptr<CellSync2Cond> cond, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2CondSignalAll(vm::ptr<CellSync2Cond> cond, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2SemaphoreInitialize(vm::ptr<CellSync2Semaphore> semaphore, vm::ptr<void> buffer, s32 initialValue, vm::cptr<CellSync2SemaphoreAttribute> attr)
{
	cellSync2.todo("cellSync2SemaphoreInitialize(semaphore=*0x%x, buffer=*0x%x, initialValue=%d, attr=*0x%x)", semaphore, buffer, initialValue, attr);

	if (!semaphore || !attr || (attr->maxWaiters > 2 && !buffer))
		return CELL_SYNC2_ERROR_NULL_POINTER;

	if (initialValue > 8388607 || initialValue < -8388608 || attr->maxWaiters == 0 || (attr->maxWaiters == 1 && buffer))
		return CELL_SYNC2_ERROR_INVAL;

	return CELL_OK;
}

s32 cellSync2SemaphoreFinalize(vm::ptr<CellSync2Semaphore> semaphore)
{
...
s32 cellSync2SemaphoreAcquire(vm::ptr<CellSync2Semaphore> semaphore, u32 count, vm::cptr<CellSync2ThreadConfig> config)
{
	cellSync2.todo("cellSync2SemaphoreAcquire(semaphore=*0x%x, count=%d, config=*0x%x)", semaphore, count, config);
...
s32 cellSync2SemaphoreTryAcquire(vm::ptr<CellSync2Semaphore> semaphore, u32 count, vm::cptr<CellSync2ThreadConfig> config)
{
	cellSync2.todo("cellSync2SemaphoreTryAcquire(semaphore=*0x%x, count=%d, config=*0x%x)", semaphore, count, config);
...
s32 cellSync2SemaphoreRelease(vm::ptr<CellSync2Semaphore> semaphore, u32 count, vm::cptr<CellSync2ThreadConfig> config)
{
	cellSync2.todo("cellSync2SemaphoreRelease(semaphore=*0x%x, count=%d, config=*0x%x)", semaphore, count, config);
...
s32 cellSync2SemaphoreGetCount(vm::ptr<CellSync2Semaphore> semaphore, vm::ptr<s32> count)
{
...
s32 cellSync2QueueInitialize(vm::ptr<CellSync2Queue> queue, vm::ptr<void> buffer, vm::cptr<CellSync2QueueAttribute> attr)
{
...
s32 cellSync2QueueFinalize(vm::ptr<CellSync2Queue> queue)
{
...
s32 cellSync2QueuePush(vm::ptr<CellSync2Queue> queue, vm::cptr<void> data, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2QueueTryPush(vm::ptr<CellSync2Queue> queue, vm::cptr<vm::cptr<void>> data, u32 numData, vm::cptr<CellSync2ThreadConfig> config)
{
	cellSync2.todo("cellSync2QueueTryPush(queue=*0x%x, data=*0x%x, numData=%d, config=*0x%x)", queue, data, numData, config);
...
s32 cellSync2QueuePop(vm::ptr<CellSync2Queue> queue, vm::ptr<void> buffer, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2QueueTryPop(vm::ptr<CellSync2Queue> queue, vm::ptr<void> buffer, vm::cptr<CellSync2ThreadConfig> config)
{
...
s32 cellSync2QueueGetSize(vm::ptr<CellSync2Queue> queue, vm::ptr<u32> size)
{
...
s32 cellSync2QueueGetDepth(vm::ptr<CellSync2Queue> queue, vm::ptr<u32> depth)
{
	cellSync2.todo("cellSync2QueueGetSize(queue=*0x%x, depth=*0x%x)", queue, depth);

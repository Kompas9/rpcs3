...
s32 cellGemGetAccelerometerPositionInDevice(/*u32 gem_num, vec_float4 *pos*/)
{
...
s32 cellGemSetYaw(/*u32 gem_num, vec_float4 z_direction*/)
{
	UNIMPLEMENTED_FUNC(cellGem);
	return CELL_OK;
}
